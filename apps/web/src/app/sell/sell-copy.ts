...
const en: typeof tr = {
  ...
  sellerType: "Seller type", phone: "Phone", authorizedPersonName: "Authorized contact name", yourName: "Your name", dealerName: "Dealer name", displayName: "Display name", selectSellerType: "Select a seller type.", missingPhone: "Your phone number is missing. Please log in again.", enterAuthorizedPerson: "Enter the authorized contact name.", enterYourName: "Enter your name.", enterDealerName: "Enter the dealer name.", enterDisplayName: "Enter a display name.",
