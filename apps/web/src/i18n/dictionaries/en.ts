...
export const en = {
  ...
  home: {
    ...
    searchHeroTitle: "Find the vehicle you are looking for",
    browseByMake: "Browse by make",
    sellCtaTitle: "Looking to sell your vehicle?",
    sellCtaBody: "Create your listing in a few steps.",
    loadError: "Listings are unavailable right now. Please try again later.",
    noMakesTitle: "No makes found",
    noMakesBody: "Makes will appear here when they are available.",
