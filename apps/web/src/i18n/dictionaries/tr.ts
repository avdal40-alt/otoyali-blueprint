...
export const tr = {
  ...
  home: {
    ...
    searchHeroTitle: "Aradığınız aracı bulun",
    browseByMake: "Markalara göz at",
    sellCtaTitle: "Aracınızı satmak mı istiyorsunuz?",
    sellCtaBody: "İlanınızı birkaç adımda oluşturun.",
    loadError: "İlanlar şu anda yüklenemiyor. Lütfen daha sonra tekrar deneyin.",
    noMakesTitle: "Marka bulunamadı",
    noMakesBody: "Marka verisi geldiğinde burada görünecek.",
