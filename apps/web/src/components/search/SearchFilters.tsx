  ...
  return (
    <div className="rounded-oto border border-oto-border bg-white p-4 shadow-soft">
      <div className="grid gap-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          <Input value={filters.yearMin} onChange={(event) => setValue("yearMin", event.target.value)} placeholder="Yil en az" inputMode="numeric" />
          <Input value={filters.yearMax} onChange={(event) => setValue("yearMax", event.target.value)} placeholder="Yil en fazla" inputMode="numeric" />
        </div>
